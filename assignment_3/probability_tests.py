...
class ProbabilityTests(unittest.TestCase):
    ...
    # Part 1c
    def test_powerplant_probs(self):
        power_plant = set_probability(make_power_plant_net())
        get_alarm_prob(power_plant)
        get_gauge_prob(power_plant)
        get_temperature_prob(power_plant)
    ...
    # Part 2c Test
    def test_gibbs(self):
        # Gibbs_sampler(get_game_network(), [2,1,3,1,1,2])
        compare_sampling(get_game_network(), [])
