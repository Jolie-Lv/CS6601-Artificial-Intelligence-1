...
from submission import PriorityQueue, a_star, bidirectional_a_star, \
    ...
    tridirectional_search, tridirectional_upgraded, custom_heuristic
...
class TestBasicSearch(unittest.TestCase):
    ...
    # def test_bidirectional_a_star_romania(self):
    #     start = 'm'
    #     goal = 's'
    #
    #     node_positions = {n: self.romania.node[n]['pos'] for n in
    ...
    # def test_tridirectional_ucs_romania(self):
    #     goals = ['a','s','m']
    #
    #     node_positions = {n: self.romania.node[n]['pos'] for n in
    #                       self.romania.node.keys()}
    ...
    #     self.draw_graph(self.romania, node_positions=node_positions,
    #                     start=goals[0], goal=goals[2], path=path)

    def test_tridirectional_a_star_romania(self):
        goals = ['a','s','m']
